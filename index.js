...
console.log("CONNECTING XTREME XMD🧬...");
...
console.log('XTREME CONNECTED TO WHATSAPP ENJOY ✅')
...
conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/s2jg91.jpg` }, caption: up })
...
//================ownerreact==============
if(senderNumber.includes("528145550855")){
if(isReact) return
m.react("👑")
}
...
app.get("/", (req, res) => {
res.send("XTREME XMD STARED GO AND ENJOY✅");
});
